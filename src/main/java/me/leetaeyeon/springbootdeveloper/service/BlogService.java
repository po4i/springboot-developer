package me.leetaeyeon.springbootdeveloper.service;
...
import me.leetaeyeon.springbootdeveloper.repository.BlogRepository;
...
public class BlogService {
    ...
    public Article findById(long id){
        return blogRepository.findById(id)
                .orElseThrow(()->new IllegalArgumentException("not fiund: "+id));
    }
